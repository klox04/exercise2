        ...
        <div className="flex justify-center flex-col items-center">
            <div className="grow shrink-0 w-[500px]">
                <div className="pt-5">
                    ...
                    {todo.isEditing ? (
                        <button onClick={updateClicked} className="mt-3 shadow bg-blue-900 hover:bg-green-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
                            Update
                        </button>
                    ) : (
                        <button onClick={buttonClicked} className="mt-3 shadow bg-blue-900 hover:bg-green-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
                            Add todo
                        </button>
                    )}
                </div>
                        ...
                        if (todo.isDone !== true) {
                            return (
                                ...
                                <li className="text-lg pt-5 flex" key={index}>
                                    ...
                                    <div>
                                        <button onClick={() => doneClicked(index)} className="mt-3 mr-4 shadow bg-blue-900 hover:bg-green-500 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
                                            Done
                                        </button>
                                        <button onClick={() => editClicked(index, todo)} className="mt-3 mr-4 shadow bg-blue-900 hover:bg-green-500 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
                                            Edit
                                        </button>
                                        <button onClick={() => deleteClicked(index)} className="mt-3 shadow bg-blue-900 hover:bg-green-500 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
                                            Delete
                                        </button>
                                    </div>
                                </li>
